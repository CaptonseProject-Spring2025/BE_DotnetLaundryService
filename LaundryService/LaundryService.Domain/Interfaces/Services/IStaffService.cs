...
namespace LaundryService.Domain.Interfaces.Services
{
    public interface IStaffService
    {
        ...
        Task ConfirmCheckingDoneAsync(HttpContext httpContext, string orderId, string notes, IFormFileCollection files);
        ...
        Task ConfirmOrderWashedAsync(HttpContext httpContext, string orderId, string notes, IFormFileCollection files);
